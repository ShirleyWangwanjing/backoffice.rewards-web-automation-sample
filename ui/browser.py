...
class Browser(object):
    def __init__(self, base_url, browser_type=BrowserType.CHROME, **browser_args):
        ...
        local_proxy_path = "C:/harfile2/browsermob-proxy-2.1.4/bin/browsermob-proxy.bat"
        ...
        if browser_type_in_lower == "ie":
            ...
            self.__web_driver = SeleniumDriver.Firefox(firefox_options=options)
        ...
        elif browser_type_in_lower == "chromwithphoebeproxy":
            ...
            #chrome_options.add_argument('--proxy-server=socks5://127.0.0.1:8088')
            capabilities = DesiredCapabilities.CHROME.copy()
            capabilities['acceptSslCerts'] = True
            capabilities['acceptInsecureCerts'] = True
            self.__web_driver = SeleniumDriver.Chrome(options=chrome_options, desired_capabilities= capabilities)
            ...
            #options.add_argument('--proxy-server=socks5://127.0.0.1:8088')
            capabilities = DesiredCapabilities.CHROME.copy()
            capabilities['acceptSslCerts'] = True
            capabilities['acceptInsecureCerts'] = True
            self.__web_driver = SeleniumDriver.Chrome(options=options, desired_capabilities=capabilities)
            proxy.new_har('req', options={'captureHeaders': True,'captureContent':True})
            self.chrome_proxy_server = server
            self.chrome_proxy = proxy
    ...
    def set_page_load_timeout(self, timeout):
        ...
        """
        self.__web_driver.set_page_load_timeout(timeout / 2000.0)
