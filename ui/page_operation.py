...
class PageOperation(ElementManager):
    ...
    def click_element(
            self, locator, until_condition=None, timeout=DEFAULT_TIMEOUT, interval=2
    ):
        """
    ...
    def key_page_up(self):
        ...
        element = self._get_element_by_tag_name('body')
        element.send_keys(Keys.PAGE_UP)

    def _get_element_by_tag_name(self, tag):
    ...
    def find_element_and_click_with_no_scroll(self, locator, timeout=DEFAULT_TIMEOUT):
        element = None
        try:
    ...
    def mouse_hover_on_element_condition(
