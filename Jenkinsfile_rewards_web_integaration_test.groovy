...
timeout(time: 3, unit: 'HOURS') {
    try {
        podTemplate(label: label,
                containers:
                        [containerTemplate(name: 'python', image: 'iherb-docker-local.jfrog.io/cibuildslave/python-selenium-chrome-proxy:t3', command: 'cat', ttyEnabled: true, alwaysPullImage:true),
